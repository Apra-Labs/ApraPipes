...
class ResizeNPPIDMA::Detail
{
public:
	Detail(ResizeNPPIDMAProps &_props) : props(_props)
	{
...
ResizeNPPIDMA::ResizeNPPIDMA(ResizeNPPIDMAProps _props) : Module(TRANSFORM, "ResizeNPPIDMA", _props), props(_props), mFrameLength(0), mFrameType(FrameMetadata::GENERAL)
{
	mDetail.reset(new Detail(_props));	
}

ResizeNPPIDMA::~ResizeNPPIDMA() {}

bool ResizeNPPIDMA::validateInputPins()
{
...
bool ResizeNPPIDMA::validateOutputPins()
{
...
void ResizeNPPIDMA::addInputPin(framemetadata_sp& metadata, string& pinId)
{
...
bool ResizeNPPIDMA::term()
{
	return Module::term();
}

bool ResizeNPPIDMA::process(frame_container &frames)
{
...
bool ResizeNPPIDMA::processSOS(frame_sp &frame)
{	
...
void ResizeNPPIDMA::setMetadata(framemetadata_sp& metadata)
{	
...
bool ResizeNPPIDMA::shouldTriggerSOS()
{
	return mFrameLength == 0;
}

bool ResizeNPPIDMA::processEOS(string& pinId)
{
	mFrameLength = 0;
	return true;
}