...
BOOST_AUTO_TEST_CASE(MONO_to_RGBA, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::MONO;
...
BOOST_AUTO_TEST_CASE(MONO_to_YUV420, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::MONO;
...
BOOST_AUTO_TEST_CASE(RGB_to_MONO, *boost::unit_test::disabled())
{
...
BOOST_AUTO_TEST_CASE(RGB_to_BGR, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::RGB;
...
BOOST_AUTO_TEST_CASE(RGB_to_RGBA, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::RGB;
...
BOOST_AUTO_TEST_CASE(RGB_to_YUV420, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::RGB;
...
BOOST_AUTO_TEST_CASE(RGBA_to_RGB, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::RGBA;
...
BOOST_AUTO_TEST_CASE(RGBA_to_YUV420, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::RGBA;
...
BOOST_AUTO_TEST_CASE(YUV420_to_MONO, *boost::unit_test::disabled())
{
...
BOOST_AUTO_TEST_CASE(YUV420_to_RGB, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::YUV420;
...
BOOST_AUTO_TEST_CASE(YUV420_to_RGBA, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::YUV420;
...
BOOST_AUTO_TEST_CASE(NV12_to_RGB, *boost::unit_test::disabled())
{
	ImageMetadata::ImageType::NV12;
...
BOOST_AUTO_TEST_CASE(NV12_to_RGBA, *boost::unit_test::disabled())
{
	for (int i = 0; i < 100; ++i)
	{
		ImageMetadata::ImageType::NV12;
