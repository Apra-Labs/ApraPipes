...
std::shared_ptr<GtkGlRenderer> GtkGl;
...
std::shared_ptr<GtkGlRenderer> launchErrorCallPipeline() {
  ...
  GtkGl = std::shared_ptr<GtkGlRenderer>(new GtkGlRenderer(gtkglsinkProps));
...
std::shared_ptr<GtkGlRenderer> laucX86Pipeline() {
  auto fileReaderProps =
      FileReaderModuleProps("./data/frame_1280x720_rgb.raw", 0, -1);
  fileReaderProps.readLoop = true;
  fileReaderProps.fps = 300;
  auto fileReader = std::shared_ptr<FileReaderModule>(
...
std::shared_ptr<GtkGlRenderer> laucX86RTSPPipeline() {
#if defined(__arm__) || defined(__aarch64__)
  ...
  auto rtspSrc = std::shared_ptr<Module>(new RTSPClientSrc(rtspProps));
  auto meta = framemetadata_sp(new H264Metadata());
  rtspSrc->addOutputPin(meta);

  auto Decoder =
      std::shared_ptr<H264Decoder>(new H264Decoder(H264DecoderProps()));
  rtspSrc->setNext(Decoder);

  auto colorchange = std::shared_ptr<ColorConversion>(
...
std::shared_ptr<GtkGlRenderer> launchPipeline1() {
#if defined(__arm__) || defined(__aarch64__)
  rtsp_client_tests_data d;
  ...
  auto source = std::shared_ptr<RTSPClientSrc>(new RTSPClientSrc(rtspProps));
  auto meta = framemetadata_sp(new H264Metadata());
...
std::shared_ptr<GtkGlRenderer> launchPipeline2() {
#if defined(__arm__) || defined(__aarch64__)
  ...
  auto source2 =
      std::shared_ptr<RTSPClientSrc>(new RTSPClientSrc(rtspProps2));
  ...
  auto decoder_12 =
      std::shared_ptr<H264Decoder>(new H264Decoder(decoder_1_Props2));
  source2->getAllOutputPinsByType(FrameMetadata::FrameType::H264_DATA);
  source2->setNext(decoder_12);

  // NV-TRANSFORM
  auto transform2 = std::shared_ptr<NvTransform>(
      new NvTransform(NvTransformProps(ImageMetadata::RGBA)));
  ...
  auto memconversion12 =
      std::shared_ptr<MemTypeConversion>(new MemTypeConversion(
          MemTypeConversionProps(FrameMetadata::CUDA_DEVICE, stream)));
  transform2->setNext(memconversion12);

  // RESIZE-NPPI
  auto resizenppi2 = std::shared_ptr<ResizeNPPI>(
      new ResizeNPPI(ResizeNPPIProps(640, 360, stream)));
  ...
  auto GtkGl2 =
      std::shared_ptr<GtkGlRenderer>(new GtkGlRenderer(gtkglsinkProps2));
...
std::shared_ptr<GtkGlRenderer> launchPipeline3() {
#if defined(__arm__) || defined(__aarch64__)
  ...
  auto source3 =
      std::shared_ptr<RTSPClientSrc>(new RTSPClientSrc(rtspProps3));
  ...
  auto decoder_13 =
      std::shared_ptr<H264Decoder>(new H264Decoder(decoder_3_Props2));
  source3->getAllOutputPinsByType(FrameMetadata::FrameType::H264_DATA);
  source3->setNext(decoder_13);

  // NV-TRANSFORM
  auto transform3 = std::shared_ptr<NvTransform>(
      new NvTransform(NvTransformProps(ImageMetadata::RGBA)));
  ...
  // RESIZE-NPPI
  auto resizenppi3 = std::shared_ptr<ResizeNPPI>(
  ...
  auto GtkGl3 =
      std::shared_ptr<GtkGlRenderer>(new GtkGlRenderer(gtkglsinkProps3));
...
std::shared_ptr<GtkGlRenderer> launchPipeline4() {
#if defined(__arm__) || defined(__aarch64__)
  ...
  auto source4 =
      std::shared_ptr<RTSPClientSrc>(new RTSPClientSrc(rtspProps4));
  ...
  auto decoder_14 =
      std::shared_ptr<H264Decoder>(new H264Decoder(decoder_4_Props2));
  source4->getAllOutputPinsByType(FrameMetadata::FrameType::H264_DATA);
  source4->setNext(decoder_14);

  // NV-TRANSFORM
  auto transform4 = std::shared_ptr<NvTransform>(
      new NvTransform(NvTransformProps(ImageMetadata::RGBA)));
  ...
  // RESIZE-NPPI
  auto resizenppi4 = std::shared_ptr<ResizeNPPI>(
  ...
  auto GtkGl4 =
      std::shared_ptr<GtkGlRenderer>(new GtkGlRenderer(gtkglsinkProps4));
...
std::shared_ptr<GtkGlRenderer> launchPipeline5() {
#if defined(__arm__) || defined(__aarch64__)
  ...
  auto source5 =
      std::shared_ptr<RTSPClientSrc>(new RTSPClientSrc(rtspProps5));
  ...
  auto decoder_15 =
      std::shared_ptr<H264Decoder>(new H264Decoder(decoder_5_Props2));
  source5->getAllOutputPinsByType(FrameMetadata::FrameType::H264_DATA);
  source5->setNext(decoder_15);

  // NV-TRANSFORM
  auto transform5 = std::shared_ptr<NvTransform>(
      new NvTransform(NvTransformProps(ImageMetadata::RGBA)));
  ...
  // RESIZE-NPPI
  auto resizenppi5 = std::shared_ptr<ResizeNPPI>(
  ...
  auto GtkGl5 =
      std::shared_ptr<GtkGlRenderer>(new GtkGlRenderer(gtkglsinkProps5));
...
std::shared_ptr<GtkGlRenderer> launchPipeline6() {
#if defined(__arm__) || defined(__aarch64__)
  ...
  auto source6 =
      std::shared_ptr<RTSPClientSrc>(new RTSPClientSrc(rtspProps6));
  ...
  auto decoder_16 =
      std::shared_ptr<H264Decoder>(new H264Decoder(decoder_6_Props2));
  source6->getAllOutputPinsByType(FrameMetadata::FrameType::H264_DATA);
  source6->setNext(decoder_16);

  // NV-TRANSFORM
  auto transform6 = std::shared_ptr<NvTransform>(
      new NvTransform(NvTransformProps(ImageMetadata::RGBA)));
  ...
  // RESIZE-NPPI
  auto resizenppi6 = std::shared_ptr<ResizeNPPI>(
  ...
  auto GtkGl6 =
      std::shared_ptr<GtkGlRenderer>(new GtkGlRenderer(gtkglsinkProps6));
