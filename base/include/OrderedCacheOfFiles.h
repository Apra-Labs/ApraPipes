...
public:
	...
	std::vector<std::filesystem::path> parseAndSortDateDir(const std::string& rootDir);
	std::vector<std::filesystem::path> parseAndSortHourDir(const std::string& rootDir);
	std::vector<std::filesystem::path> parseAndSortMp4Files(const std::string& rootDir);
	...
	bool probe(std::filesystem::path dirPath, std::string& videoName);
...
private:
	...
	bool datePatternCheck(const std::filesystem::path& path);
	bool hourPatternCheck(const std::filesystem::path& path);
