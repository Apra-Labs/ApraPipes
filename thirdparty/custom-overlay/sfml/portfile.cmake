...
# Only handle debug libs if debug directory exists (not in release-only builds)
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug" AND EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/sfml-main-d.lib")
